...
public class ProductController {
	...
	@GetMapping("/products") // get ful list of products
	...
	@GetMapping("/products/{id}") // get details of products with id=N
	...
	public ResponseEntity<List<Product>> getProductsByCategory(@PathVariable("category") String category) {
		List<Product> categoryData = repository.findByCategory(category);		;
		
		if (Optional.of(categoryData).isPresent()) {
